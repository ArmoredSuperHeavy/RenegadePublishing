% universal settings
\documentclass[smalldemyvopaper,14pt,twoside,onecolumn,openright,extrafontsizes,showtrims]{memoir}
...
\usepackage{hyphenat} % for hyphens that will text wrap better?
...
\usepackage{pxfonts} % black heart icon!
\usepackage{textpos} % absolute positioning (for QR code)
\usepackage{graphicx} % images
\usepackage{lipsum} % to generate Lorem Ipsum
\usepackage{fontspec} % font 

% FONTS
\newfontface\myCursive{Libre Caslon Display} [Contextuals={WordInitial,WordFinal}]
\newfontface\myBorder{ornaments labels and frames} [Contextuals={WordInitial,WordFinal}]
\fontspec{Cormorant Garamond}

% PHYSICAL DOCUMENT SETUP
\setstocksize{17cm}{13.5cm} 
\settrimmedsize{16.95cm}{13.45cm}{*}
\setbinding{1.5cm}
\setlrmarginsandblock{0cm}{2.5cm}{*} 
\setulmarginsandblock{2cm}{2cm}{*} 
\settypeblocksize{11cm}{8.25cm}{*}
\addtolength{\uppermargin}{1.25cm} 

\settrims{0.1mm}{0mm}


% setting really tiny trim lines
...
% TITLE & AUTHOR INFO
\title{The Masque of the Red Death}
...
\newcommand*\titleM{\begingroup
  ...
  \vspace*{\drop}
  \rule{\textwidth}{0in}\par
  {\textsc\myCursive\Huge\textsc\thetitle\par}
  \rule{\textwidth}{0in}\par
...
% HEADER AND FOOTER MANIPULATION
  ...
  \makeevenhead{mystyle}{\textsf{   \Large   \thepage }}{\textsf{    \large  \scshape \theauthor }}{}
  \makeoddhead{mystyle}{}{\textsf{     \scshape\leftmark \thetitle  }}{ \textsf{    \Large \thepage } }
...
\noindent{\large A small Franchise Name (TV) fic}

\noindent{\large Published:1842-05}

\noindent{\large 1,500 words}

    \vspace*{\fill}

   \includegraphics[scale=0.15]{../sithelTumblrCode}

     \vspace*{\fill}
  
  
\noindent{\Large For this and other works by \theauthor}
\noindent{\texttt https://archiveofourown.org/}
...
\begin{center}
 ...
 \par\vfill\noindent  {\large Printed and bound for amusement\space\today}
   \includegraphics[scale=0.15]{../sithelTumblrCode}
    \includegraphics[scale=0.3]{../cpp_logo}
\end{center}
\frontmatter
...
% This size book is hell on justified text. Give hyphenation suggestions to TeX here:
\hyphenation{Chris-tina}
\hyphenation{Will-iam}
\hyphenation{solemn-ly}
\tolerance=5000
